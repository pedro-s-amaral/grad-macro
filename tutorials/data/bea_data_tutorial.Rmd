...
The first thing you need to do is to obtain a data key from the BEA. To do this you need to register for an API key on their website by providing your name and email address [at their website](https://apps.bea.gov/API/signup/index.cfm). This key will be emailed to you and is required to access BEA data through their API.
...
You can learn more details about this package  [in its vignette](chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/https://cran.r-project.org/web/packages/bea.R/bea.R.pdf), while [this document works like a dictionary](https://apps.bea.gov/api/_pdf/bea_web_service_api_user_guide.pdf) and contains a list of the table codes among other things. 
...
```{r, fig.alt="Figure showing shares of nondurable goods, durable goods, and services in overall consumption"}
