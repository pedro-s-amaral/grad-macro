...
One of the routines we can use to solve a constrained optimization problem in R is `solnl` (but there are others). See [the documentation](https://www.rdocumentation.org/packages/NlcOptim/versions/0.6/topics/solnl).
